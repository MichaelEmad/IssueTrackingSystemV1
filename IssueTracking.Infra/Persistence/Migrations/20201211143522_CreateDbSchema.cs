    ...
    public partial class CreateDbSchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Issue_AspNetUsers_ReporterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ParticipantsProjectsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ParticipantsProjectsId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectUser", x => new { x.ParticipantsProjectsId, x.ParticipantsProjectsId1 });
                    table.ForeignKey(
                        name: "FK_ProjectUser_AspNetUsers_ParticipantsProjectsId",
                        column: x => x.ParticipantsProjectsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectUser_Project_ParticipantsProjectsId1",
                        column: x => x.ParticipantsProjectsId1,
                        principalTable: "Project",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
